  ...
  return (
    <div>
      <div className="grid gap-y-20">
        <div className="flex justify-end p-4" onClick={() => setHide(true)}>
        ...
        <nav className="p-2 flex flex-col justify-evenly">
          <p className="text-2xl m-2 font-medium">Home</p>
          <p className="text-2xl m-2 font-medium">New</p>
          <p className="text-2xl m-2 font-medium">Popular</p>
          <p className="text-2xl m-2 font-medium">Trending</p>
          <p className="text-2xl m-2 font-medium">Categories</p>
        </nav>
      </div>
    </div>
  );
  ...
  return (
    <div className="py-4">
      <nav className="flex justify-between items-center">
        ...
        {hide ? (
          <div className="lg:hidden" onClick={() => setHide(false)}>
